        ...
        try {
            ...
            if (dbDataDir.isDirectory()) {
                ...
                book1.setTitle("Little Brother")
                        .setDescription("How to attack with metasploit.")
                        .setPdfFileName("metasploit.pdf")
                        .setCoverPhotoName("metasploit.jpg")
                        .setRole(FreeRole);
                bookRepository.save(book1);

                Book book2 = new Book();
                book2.setTitle("Hacking Facebook")
                        .setDescription("How to become a Facebook Hacker")
                        .setPdfFileName("FacebookHacking.pdf")
                        .setCoverPhotoName("FacebookHacking.jpg")
                        .setRole(PremiumRole);
